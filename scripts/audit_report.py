...
<head>
  ...
  <style>
    ...
    * {{ box-sizing: border-box; margin: 0; padding: 0; }}
    ...
    /* ── Header Scores (compact, matches Vercel app) ── */
    .header-scores {{
      display: flex;
      align-items: center;
      gap: 16px;
    ...
    .header-score-overall {{
      text-align: center;
      border-left: 1px solid rgba(255,255,255,0.3);
      padding-left: 16px;
    }}
    .header-score-overall .score-value {{
      font-size: 36px;
      font-weight: 700;
      color: white;
    }}
    .header-score-overall .score-label {{
      font-size: 10px;
      text-transform: uppercase;
      letter-spacing: 0.05em;
      opacity: 0.8;
    ...
    <div class="report-header-top">
      ...
      <div class="header-scores">
        <div class="header-score-item">
          <div class="score-value">{readiness_score if readiness_score is not None else '—'}%</div>
          <div class="score-label">Readiness</div>
        </div>
        <div class="header-score-item">
          <div class="score-value">{f'{design_score_val}%' if design_score_val is not None else 'N/A'}</div>
          <div class="score-label">Design</div>
        </div>
        <div class="header-score-item">
          <div class="score-value">{a11y_score_val if a11y_score_val is not None else '—'}%</div>
          <div class="score-label">A11y</div>
        </div>
        <div class="header-score-overall">
          <div class="score-value" style="color: {score_color}">{overall_score}%</div>
